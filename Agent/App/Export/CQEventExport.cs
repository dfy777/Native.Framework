...
namespace Native.Csharp.App.Export
{
	...
	{	
		...
		{	
			...
			type.GetProperty ("Version", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { new Version ("5.0.0") });	
			...
			type.GetProperty ("Description", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { "酷Q样例应用" });	
